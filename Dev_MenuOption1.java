...
public class Dev_MenuOption extends Dev_MainMenu{
    ...
    public void addedCustomerDetails12()
    {
   ...
   public  Customer getCustomerId(int CusId) {
       Customer cust = null;
       for (int i = 0; i < CusCount; i++) {
           if (CusArray[i].getCustomerId() == CusId) {
               cust = CusArray[i];
               break;
           }
       }
   ...
   public void openAccount() {
       ...
       Customer cust = getCustomerId(acNum); 
       if(acNum!=cust.getCustomerId())
       {
...
public void CustomerAdd() throws IOException {
       ...
       if (CusCount == TOTAL_Customer_LIMIT) {
           System.out.println("Limit reached, can't create more than " + 
                   TOTAL_Customer_LIMIT + " CustomerID");
           return;
       }
       System.out.println("\tADD NEW CUSTOMER");
       System.out.println("Enter the following details");
    ...
    //   do {
       ...
       if(pin1<100000||pin>999999)
       {
           System.out.println("Please enter valid PIN");
       }
       }while(pin1<100000||pin1>999999);
       System.out.println("Enter Mobile No. : ");
       long mobileNo1=Long.parseLong(br.readLine());
       System.out.println("Enter E-mail in valid format(abc@xyz.com) : ");
       ...
       int customerId1=random();
       
       
      // }while(choice=='r'||choice=='R');
      // int cus=CusCount++;
       //System.out.println(CusCount++);
       CusArray[CusCount++] = new Customer(customerId1, name1, gender1, dob1 ,address1,city1,state1,pin1,mobileNo1,email1);
       //count=CusCount;
       //System.out.println(CusArray[0].getCity());
       Customer cust = getCustomerId(customerId1); 
       ...
       for (int i = 0 ;i <CusCount; i++) {
           System.out.println("Testing");
            System.out.println("\tCustomer ID : "+CusArray[i].getCustomerId());
            System.out.println("Customer Name :\t"+CusArray[i].getName());
            System.out.println("Gender        :\t"+CusArray[i].getGender());
            System.out.println("Birthdate     :\t"+CusArray[i].getDob());
            System.out.println("Address       :\t"+CusArray[i].getAddress());
            System.out.println("City          :\t"+CusArray[i].getCity());
            System.out.println("State         :\t"+CusArray[i].getState());
            System.out.println("PIN           :\t"+CusArray[i].getPin());
            System.out.println("Mobile No.    :\t"+CusArray[i].getMobileNo());
            System.out.println("Email         :\t"+CusArray[i].getEmail());
           
       }
       //cust.addedCustomerDetails();
}
/*
